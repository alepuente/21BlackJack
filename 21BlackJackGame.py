...
def StartGame():   
    ...
    #Check if there is any aces in the hand
    player1.checkAces()    
    ...
    if(player1.handValue>21):
        ...
        print("Dealer score({}) is same or higher than yours({}) you lose".format(dealer.handValue,player1.handValue))
        loses += 1
    elif(dealer.handValue < 21 and player1.handValue>= dealer.handValue):
